...
- Do not use proprietary, trademarked, or copied brand/platform icon assets as generic UI icons, including Apple logos or SF Symbols. Prefer an open-source icon family with a compatible license, and verify asset provenance before adding it.
